...
export class RoomsComponent {
	...
	protected readonly rooms: RoomCard[] = [
		{
			...
			imageAlt: 'Демо номер Делюкс із балконом у Flyashka-Restoratsiya',
		},
		{
			...
			imageAlt: 'Демо номер Стандарт бізнес у Flyashka-Restoratsiya',
		},
		{
			name: 'Преміум номер',
			description:
			...
			imageAlt: 'Демо Преміум номер у Flyashka-Restoratsiya',
		},
	];
	...
	protected readonly contactLinks: ContactLink[] = [
		...
		},
		{
			...
			href: 'https://example.com/flyashka-restoratsiya-demo/viber',
			description: 'Демо-чат для швидкого бронювання',
		},
		{
			label: 'Написати у Telegram',
			href: 'https://example.com/flyashka-restoratsiya-demo/telegram',
			description: '@flyashka-restoratsiya_demo',
		},
	];
}
